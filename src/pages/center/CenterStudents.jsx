...
export default function CenterStudents() {
  ...
  async function fetchStudents(centerId) {
    ...
    const { data } = await supabase
      .from('students')
      .select('id, student_name, enrollment_no, admission_number, mobile_no, gender, status, remarks, doc_verified_at, forwarded_at, semester_year, fee_collected, coupon_discount, fee_sharing_pct, center_id, programme_id, session_id, programs(program_name, duration, semester_year), academic_sessions(session_name)')

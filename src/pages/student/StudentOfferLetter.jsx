...
export default function StudentOfferLetter() {
  ...
  const released = !!data.offer_letter_active
  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl">
      ...
      {!isPhd ? (
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-700 font-medium flex items-center gap-2">
          <Lock size={15} /> Your offer letter has not been released yet. It will appear here once the Research Department publishes it.
        </div>
      ) : (

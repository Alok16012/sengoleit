      ...
      {!isPhd ? (
        ...
        <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden shadow-sm">
          <div className="bg-[#933d18] text-white text-center py-3">
            <span className="font-black text-base tracking-wide">ENTRANCE CLEARANCE CERTIFICATE</span>
          </div>
          <div className="p-6 space-y-2 text-sm text-gray-800">
            ...
            <p className="text-gray-500 pt-2 text-xs">Click “Download Certificate” for the full printable document.</p>
          </div>
        </div>
      )}
    </div>
